...
def focal_loss(
    ...
    # W compute sigmoid because we want binary cross entropy loss
...
class FocalLoss(nn.Module):
    ...
    Shape:
        ...
        - Target: :math:`(N, C)` Binary one hot vector
...
if __name__ == "__main__":
    ...
    loss = FocalLoss(0.5, 2.0, 'mean')
    input = torch.rand(10, 5) - 0.5
    gt = (torch.rand(10, 5) > 0.1).float()
    output = loss(input, gt)
