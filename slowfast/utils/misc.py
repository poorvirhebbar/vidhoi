...
def check_nan_losses(loss,optimizer):
    """
...
def is_eval_epoch(cfg, cur_epoch, multigrid_schedule):
    ...
    """
    if cfg.TRAIN.EVAL and (cur_epoch + 1 == cfg.SOLVER.MAX_EPOCH):
        return True
    ...
    return cfg.TRAIN.EVAL and  ((cur_epoch + 1) % cfg.TRAIN.EVAL_PERIOD == 0)
