...
# If True, will evaluate model after EVAL_PERIOD
_C.TRAIN.EVAL = True
...
# Flag to save images with bboxes and preds
_C.TEST.SAVE_IMGS = False
...
# Model architrcture that uses single pathway sampled framed
_C.MODEL.SINGLE_SAMPLED_PATHWAY_ARCH = ["lighten", "resnet50", "resnext101", "resnet101"]
...
# to use saved features
_C.MODEL.USE_SAVED_FEAT = False
_C.MODEL.SAVE_FEAT = False

# use label weights in loss function
_C.MODEL.USE_LABEL_WEIGHTS = False

# use action label prior
_C.MODEL.USE_ACTION_PRIOR = False

_C.MODEL.USE_UNION_BBOX = False

# Final Dropout rate.
_C.MODEL.DROPOUT = 0.0

# to choose RNN
_C.MODEL.USE_DEDICATED_RNN = False

# to remove RNN and use 3d convolution
_C.MODEL.USE_3D_CONV = False

# to apply high weights to low freq. labels
_C.MODEL.INC_WEIGHTS = False

# to apply low weight to watch and behind labels
_C.MODEL.DEC_WEIGHTS_14 = False

# to use focal loss
_C.MODEL.USE_FOCAL_LOSS = False

# avg features instead of concat
_C.MODEL.AVG_FEAT = False

_C.MODEL.USE_COORD_MASK = False
_C.MODEL.USE_ALPHA_POSES = False
_C.MODEL.USE_PROPENSITY = False
# -----------------------------------------------------------------------------
...
#max objs for agcn nodes
_C.LIGHTEN.MAX_OBJS = 28

# Backbone feature generator
_C.LIGHTEN.BACKBONE = "resnext101"

# Freeze the backbone network and only finetune subsequent modules
_C.LIGHTEN.FREEZE_BACKBONE = True
...
# Freeze the backbone network and only finetune subsequent modules
_C.SLOWFAST.FREEZE_BACKBONE = False
...
#_C.VIDOR.FRAME_DIR = "/mnt/data/apoorva/HOI_vidhoi/slowfast/datasets/vidor/frames"
_C.VIDOR.FRAME_DIR = "slowfast/datasets/vidor/frames"

# Directory path for files of frame lists.
_C.VIDOR.FRAME_LIST_DIR = (
    #"/home/aicsvidhoi1/SlowFast/slowfast/datasets/vidor/frame_lists"
    #"/mnt/data/apoorva/HOI_vidhoi/slowfast/datasets/vidor/frame_lists"
...
_C.VIDOR.ANNOTATION_DIR = (
    ...
    #"/mnt/data/apoorva/HOI_vidhoi/slowfast/datasets/vidor"
    "slowfast/datasets/vidor"
)

# Directory path for features files.
_C.VIDOR.FEAT_DIR = (
    #"/home/aicsvidhoi1/SlowFast/slowfast/datasets/vidor"
    #"/mnt/data2/apoorva/vidhoi/resnext101_feat"
    "slowfast/datasets/vidor/resnext101_feat"
)

#added by poorvi for detecting trajectories, change it when testing with no gt
_C.VIDOR.TRAJ_DIR = (
    #"/home/aicsvidhoi1/SlowFast/slowfast/datasets/vidor"
    "/mnt/data2/apoorva/vidhoi/resnext101_feat_detect"
)
...
# name of label frequency file
_C.VIDOR.LABEL_FREQ_FILE = 'pred_category_freq.pkl'

# multi label action label prior
_C.VIDOR.ACTION_PRIOR_FILE = 'multi_label_action_prior.pkl'
